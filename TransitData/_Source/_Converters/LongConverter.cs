...
namespace Magikarp.Utility.TransitData
{
    ...
    /// Version: 20170921
    /// </remarks>
    public class LongConverter : BaseConverter
    {
        ...
        {
            if ((pi_objValue != null) && (long.TryParse(pi_objValue.Value, out long lValue)))
            {
                pi_objProperty.SetValue(pi_objContainer, lValue, null);
            }
            else
            {
